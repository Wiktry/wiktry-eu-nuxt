  ...
  <aside class="personal-info" :class="{ 'aside-open': openAside }" :style="{ '--width': width + 'px', '--padding': (width - 240) / 2 + 'px' }">
    ...
    <div class="experience-cont">
      <div class="experience">
        <div class="extra-info">
          <one-index-aside-extra-info :title="text.extra.country.title" :response="text.extra.country.response" />
          <one-index-aside-extra-info :title="text.extra.state.title" :response="text.extra.state.response" />
          <one-index-aside-extra-info :title="text.extra.city.title" :response="text.extra.city.response" />
          <one-index-aside-extra-info :title="text.extra.age.title" :response="text.extra.age.response" />
        </div>
        <v-divider />
        <div class="language">
          <one-index-aside-radial-progress :title="text.lang.swedish.title" :value="text.lang.swedish.value" />
          <one-index-aside-radial-progress :title="text.lang.english.title" :value="text.lang.english.value" />
        </div>
        <v-divider />
        <div class="p-language">
          <one-index-aside-linear-progress :title="text.pLang.html.title" :value="text.pLang.html.value" />
          <one-index-aside-linear-progress :title="text.pLang.css.title" :value="text.pLang.css.value" />
          <one-index-aside-linear-progress :title="text.pLang.js.title" :value="text.pLang.js.value" />
          <one-index-aside-linear-progress :title="text.pLang.react.title" :value="text.pLang.react.value" />
          <one-index-aside-linear-progress :title="text.pLang.vue.title" :value="text.pLang.vue.value" />
          <one-index-aside-linear-progress :title="text.pLang.cpp.title" :value="text.pLang.cpp.value" />
        </div>
        <v-divider />
    ...
    <div class="aside-footer">
      ...
      <div class="footer-button" v-if="width <= 600">
        <one-index-aside-reveal @reveal="openAside = !openAside" :active="openAside" />
      </div>
    </div>
  </aside>
</template>
